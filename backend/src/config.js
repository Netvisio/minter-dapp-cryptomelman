...
const extraMetadata = {
  external_url: "https://cryptomelman.xyz", // Replace with your website or remove this line if you do not have one.
};
...
const CHAIN = 'polyfon'; // only rinkeby or polygon

// REQUIRED CONTRACT DETAILS THAT CANNOT BE UPDATED LATER!
const CONTRACT_NAME = 'Crypto Melman';
const CONTRACT_SYMBOL = 'CMNFT';
...
const PUBLIC_MINT_START_DATE = "2022-06-03T11:59:48+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00

// OPTIONAL CONTRACT DETAILS THAT CAN BE UPDATED LATER.
const PRESALE_MINT_START_DATE = "2022-05-17T11:59:48+00:00"; // Optional. Eg: 2022-02-08T11:30:48+00:00
const ROYALTY_SHARE = 1000; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0xdAD1746335198B0dd1aA4EfeC54285b04C43C73F"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0xdAD1746335198B0dd1aA4EfeC54285b04C43C73F"]; // only update if you want to manually set the whitelisted addresses

// ** OPTIONAL **
let CONTRACT_ADDRESS = "0xb30dD53AeFE8a50079177bc8B0404571e9757D76"; // If you want to manually include it
...
const solanaMetadata = {
  ...
  external_url: "https://crypromelman.xyz",
  creators: [
    {
      address: "FfmZcgouKN7NmrnjF18acifvBy8xAJoPt1riiqgn6KU8",
      share: 100,
    },
  ],
};
